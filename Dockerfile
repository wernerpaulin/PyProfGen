...
#docker build --rm -t pyprofgen:2.0.0 .
#docker save -o pyprofgen-2-2-0.tar pyprofgen:2.2.0
#docker run -d --rm --network host -e MQTT_BROKER_IP=localhost -e MQTT_BROKER_PORT=1883 -e MQTT_BROKER_KEEPALIVE=60 --name pyprofgen-app pyprofgen:2.0.0
